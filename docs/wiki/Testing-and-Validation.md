...
- `npm run check:rpc-policy` passes and confirms the primary chain has at least two distinct RPC upstreams unless you explicitly opted into a weaker override
