...
- optional Myspace-style profile customization with blurbs, Top Friends, testimonials, a profile song, structured custom boxes, a status headline, retro stamps, a guestbook with owner moderation, plus sandboxed custom HTML/CSS modules
