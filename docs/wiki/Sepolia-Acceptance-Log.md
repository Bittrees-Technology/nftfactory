...
- NFT-SEP-010: Confirm `/discover` profile, collection, and NFT browse views
- NFT-SEP-011: Confirm public creator page rendering from `/profile/[name]`
- NFT-SEP-012: Exercise profile-linked listing management on the public profile flow
- NFT-SEP-013: Exercise guestbook moderation visibility from `/profile/moderation`
