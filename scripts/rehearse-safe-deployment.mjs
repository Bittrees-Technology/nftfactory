...
try {
 ...
 console.log(JSON.stringify({isolatedFork:true,publicBroadcast:false,deploymentTransactions:manifest.transactions.length,safeAcceptedOwners:transfers.length,adminSafe:safe}));
