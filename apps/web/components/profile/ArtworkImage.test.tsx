...
it('uses configured primary then replica before the indexer gateway', () => {
  expect(artworkSources('https://dweb.link/ipfs/bafytest', 'https://primary.example/ipfs/', 'https://backup.example')).toEqual(['https://primary.example/ipfs/bafytest','https://backup.example/ipfs/bafytest','https://dweb.link/ipfs/bafytest']);
});
