...
it('requires a connected wallet',()=>{mocks.address='';render(<ProfileModerationClient/>);expect((screen.getByRole('button',{name:'Load Guestbook'})as HTMLButtonElement).disabled).toBe(true);expect(screen.getByText('Connect your wallet in the top-right toolbar.')).toBeTruthy();});
