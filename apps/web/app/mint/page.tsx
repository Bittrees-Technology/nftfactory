...
export default async function MintPage({ searchParams }: MintPageProps) {
  ...
  if(!getEnabledAppChainIds().includes(targetChainId))notFound();
  ...
  if (initialPageMode === "mint" && initialMintMode === "shared") return <CreateClient key={targetChainId} initialChainId={targetChainId} />;
